-- =============================================================================
-- 🚀 RESET TOTAL E CONFIGURAÇÃO DO SISTEMA GRÊMIO v4 (FINAL - COMPATÍVEL COM FRONT)
-- =============================================================================
-- Correções v4:
--   • Re-adicionado diary_entries e system_logs (front depende deles)
--   • Adicionado events.location e events.created_by
--   • RLS ajustado para login customizado (sem depender de auth.uid())
--   • Status/priority em inglês (bater com CONFIG.STATUS do JS)
-- =============================================================================
...
-- =============================================================================
-- SEGURANÇA E RLS (Compatível com login customizado via access_code)
-- =============================================================================
-- NOTA: O sistema NÃO usa Supabase Auth. Login é via access_code + birth_date.
-- Sessão fica em localStorage. Portanto NÃO usamos auth.uid() nas policies.
-- Controle de permissão é feito no JS (requireAdmin / requireAuth).
--
-- REGRAS DO SUPABASE RLS:
--   SELECT → USING
--   INSERT → WITH CHECK
...
-- =============================================================================
-- POPULAÇÃO DE DADOS (Sincronizado com Departamentos + Cores Educa Mais)
-- =============================================================================
